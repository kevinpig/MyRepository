...
// This file is auto-generated by the uWS.Dicom.DataDictionaryGenerator project.
...
namespace uWS.Dicom
{
    ...
    public class DicomTagDictionary
    {
        ...
        {
			using (var stream = typeof(DicomTagDictionary).Assembly.GetManifestResourceStream("uWS.Dicom.DicomTagDictionary.data"))
			{
				if(stream == null)
