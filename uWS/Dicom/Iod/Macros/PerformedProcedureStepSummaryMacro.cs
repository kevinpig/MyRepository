...
using uWS.Dicom.Iod.Macros.PerformedProcedureStepSummary;
using uWS.Dicom.Iod.Macros.PerformedProcedureStepSummary.PerformedProtocolCodeSequence;
...
namespace uWS.Dicom.Iod.Macros
{
	...
	internal class PerformedProcedureStepSummaryMacro : IodBase, IPerformedProcedureStepSummaryMacro
	{
		...
		/// <summary>
		/// Gets an enumeration of <see cref="uWS.Dicom.DicomTag"/>s used by this macro.
		/// </summary>
