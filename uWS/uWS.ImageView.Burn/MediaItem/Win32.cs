...
namespace uWS.ImageView.Burn.MediaItem
{
    ...
    class Win32
    {
        ...
        [DllImport("shlwapi.dll", CharSet = CharSet.Unicode, ExactSpelling = true, 
            PreserveSig = false, EntryPoint = "SHCreateStreamOnFileW")]
        ...
        public static extern int GetDiskFreeSpace(string dirName, out ulong 
            freeBytesAvailableToCaller, out ulong totalNumberOfBytes, 
