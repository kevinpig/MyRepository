...
namespace uWS.Pacs.DicomService
{
    ...
    public class ServerPartitionMonitor : IEnumerable<ServerPartition>, IDisposable
    {
        ...
        private ServerPartitionMonitor()
        {
            ...
            // _timer = new Timer(SynchDB, null,
            //                   TimeSpan.FromSeconds(Settings.Default.DbChangeDelaySeconds),
            //                   TimeSpan.FromSeconds(Settings.Default.DbChangeDelaySeconds));
        }
        ...
        private bool IsChanged(ServerPartition partition)
        {
            ...
            if (origalPartition.PatitionFolder != partition.PatitionFolder)
            {
                return true;
            }
        ...
        public ServerPartition GetPartition(string serverAe)
        {
            ...
            throw new Exception("The Special partition is not find. ");
        }
