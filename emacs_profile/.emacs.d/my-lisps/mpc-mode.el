...
(defvar mpc-font-lock-keywords
  `(
	...
	("\\(staticname\\)"           1 font-lock-type-face t)
	...
	("\\(pure_libs =\\)"          1 font-lock-type-face t)
...
(defvar mpc-mode-abbrev-table nil
  "Abbrev table in use in `mpc-mode' bufferrs.")
(define-abbrev-table 'mpc-mode-abbrev-table nil)
...
"
  ...
  (setq mode-name "MPC")
  (setq local-abbrev-table mpc-mode-abbrev-table)
